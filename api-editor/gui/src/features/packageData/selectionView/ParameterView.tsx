        ...
        datasets: [
            {
                ...
                borderColor: labels.map((key) => (isStringifiedLiteral(key) ? 'rgba(137, 87, 229, 1)' : '#888888')),
                backgroundColor: labels.map((key) => (isStringifiedLiteral(key) ? 'rgba(137, 87, 229, 0.2)' : '#888888')),
            },
        ],
    };
