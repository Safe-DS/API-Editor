...
const UsageImportDialog: React.FC<ImportPythonPackageDialogProps> =
    function ({ setUsages }) {
            ...
            <Modal onClose={close} isOpen size="xl">
                ...
                <ModalContent>
                    ...
                    <ModalBody>
                        <FormControl>
                            <FormLabel>
                                Select a usage file to import.
                            </FormLabel>
                            <StyledDropzone onDrop={slurpAndParse}>
                                <ChakraText>
                                    Drag and drop a usage file here or click
                                    to select the file.
                                </ChakraText>
                                <ChakraText>
