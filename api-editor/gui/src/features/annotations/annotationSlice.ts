...
const annotationsSlice = createSlice({
    ...
    reducers: {
        ...
        removeAttribute(state, action: PayloadAction<string>) {
            removeAnnotation(state, state.annotations.attributes, action.payload);
            updateQueue(state);
        },
        ...
        removeBoundary(state, action: PayloadAction<string>) {
            removeAnnotation(state, state.annotations.boundaries, action.payload);
            updateQueue(state);
        },
        ...
        removeCalledAfter(state, action: PayloadAction<CalledAfterTarget>) {
            removeAnnotation(state, state.annotations.calledAfters[action.payload.target], action.payload.calledAfterName);
        ...
        removeConstant(state, action: PayloadAction<string>) {
            removeAnnotation(state, state.annotations.constants, action.payload);
            updateQueue(state);
        },
        ...
        removeDescription(state, action: PayloadAction<string>) {
            removeAnnotation(state, state.annotations.descriptions, action.payload);
            updateQueue(state);
        },
        ...
        removeEnum(state, action: PayloadAction<string>) {
            removeAnnotation(state, state.annotations.enums, action.payload);
            updateQueue(state);
        },
        ...
        removeGroup(state, action: PayloadAction<GroupTarget>) {
            removeAnnotation(state, state.annotations.groups[action.payload.target], action.payload.groupName);
        ...
        removeMove(state, action: PayloadAction<string>) {
            removeAnnotation(state, state.annotations.moves, action.payload);
            updateQueue(state);
        },
        ...
        removeOptional(state, action: PayloadAction<string>) {
            removeAnnotation(state, state.annotations.optionals, action.payload);
            updateQueue(state);
        },
        ...
        removePure(state, action: PayloadAction<string>) {
            removeAnnotation(state, state.annotations.pures, action.payload);
            updateQueue(state);
        },
        ...
        removeRenaming(state, action: PayloadAction<string>) {
            removeAnnotation(state, state.annotations.renamings, action.payload);
            updateQueue(state);
        },
        ...
        removeRequired(state, action: PayloadAction<string>) {
            removeAnnotation(state, state.annotations.requireds, action.payload);
            updateQueue(state);
        },
        ...
        removeRemove(state, action: PayloadAction<string>) {
            removeAnnotation(state, state.annotations.removes, action.payload);
            updateQueue(state);
        },
        ...
        removeTodo(state, action: PayloadAction<string>) {
            removeAnnotation(state, state.annotations.todos, action.payload);
            updateQueue(state);
        },
