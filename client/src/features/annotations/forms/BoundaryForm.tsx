...
const BoundaryForm: React.FC<BoundaryFormProps> = function({ target }) {
    ...
    const unrestrictedInterval = () => {
        ...
        return !(lowerLimitType === ComparisonOperator.UNRESTRICTED && upperLimitType === ComparisonOperator.UNRESTRICTED)
    }
        ...
        >
            ...
            <HStack spacing='10px' alignItems='flexStart'>
                ...
                >
                    ...
                    >
                        <option
                            value={ComparisonOperator.LESS_THAN_OR_EQUALS}>≤
                        </option>
                        <option
                            value={ComparisonOperator.LESS_THAN}>{'<'}</option>
                        <option value={ComparisonOperator.UNRESTRICTED}>no lower
                            limit
                        </option>
                    </Select>
                    <FormErrorMessage>
                        <FormErrorIcon />
                        {
                            ...
                            errors?.interval?.lowerLimitType?.type === 'unrestrictedInterval' && 'Interval is unrestricted.'
                        }
                    </FormErrorMessage>
                </FormControl>
                ...
                >
                    ...
                    >
                        ...
                        <option
                            value={ComparisonOperator.LESS_THAN}>{'<'}</option>
                        <option value={ComparisonOperator.UNRESTRICTED}>no upper
                            limit
                        </option>
                    </Select>
                    <FormErrorMessage>
                        <FormErrorIcon />
                        {
                            ...
                            errors?.interval?.upperLimitType?.type === 'unrestrictedInterval' && 'Interval is unrestricted.'
                        }
                    </FormErrorMessage>
                </FormControl>
                <FormControl
