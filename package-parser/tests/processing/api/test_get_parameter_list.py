...
def test_get_parameter_list_on_global_functions(python_code: str, expected_parameter_list: list):
    ...
    expected_parameter_list = [
        it.to_json()
        for it in expected_parameter_list
    ]
...
def test_get_parameter_list_on_method(python_code: str, expected_parameter_list: list):
    ...
    actual_parameter_list = [
        it.to_json()
        for it in get_parameter_list(DefaultDocumentationParser(), node, "C/f", "C.f", True)
    ]
