...
@pytest.mark.parametrize(
    "annotation,json",
    [
        (AbstractAnnotation("test/test", ["$autogen$"], ["aclrian"], "Autogenerated"),
         {
            "target": "test/test",
            "authors": ["$autogen$"],
            "reviewers": ["aclrian"],
    ...
    ], ids=["test import and export of base annotation", "test import and export of boundary annotation", "test import and export of constant annotation",
