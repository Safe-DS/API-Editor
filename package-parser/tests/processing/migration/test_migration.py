...
def migrate_rename_annotation_data_one_to_many_mapping__with_changed_new_name() -> Tuple[
    ...
    annotationsv2 = RenameAnnotation(
        ...
        authors=["testauthor", migration_author],
        reviewers=[],
        comment="The @Rename Annotation with the new name 'TestA' from the previous version was at 'test/test.Test' and the possible alternatives in the new version of the api are: test/test.TestA, test/test.TestB",
...
def migrate_rename_annotation_data_one_to_many_mapping() -> Tuple[
    ...
    annotationsv2_a = TodoAnnotation(
        ...
        comment="",
        reviewResult=EnumReviewResult.NONE,
        newTodo="The @Rename Annotation with the new name 'TestZ' from the previous version was at 'test/test.Test' and the possible alternatives in the new version of the api are: test/test.TestA, test/test.TestB",
    )
