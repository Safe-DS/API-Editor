...
from package_parser.commands.get_api import API, Function, Module, Parameter, ParameterAssignment, \
...
def test_get_annotations(subfolder: str, get_annotations: Callable[[UsageCountStore, API, AnnotationStore], None]):
