...
internal class ModuleAdapterContentBuilderTest {
    @Test
    fun buildModuleContentReturnsFormattedModuleContent() {
        ...
        // when
        val moduleAdapterContentBuilder = ModuleAdapterContentBuilder(testModule)
        val moduleContent = moduleAdapterContentBuilder.buildModuleContent()
